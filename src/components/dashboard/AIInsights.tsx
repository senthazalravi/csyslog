...
const mockInsights: Insight[] = [
  ...
  },
  {
    ...
    description: "SMART data analysis indicates /dev/sdb may fail within 30 days. Current reallocated sector count: 128 (threshold: 200).",
  ...
  },
  {
    ...
    description: "Detected 12% packet loss on internal subnet during peak hours. Suggest adjusting QoS rules for monitoring traffic.",
  ...
  },
  {
    ...
    description: "Detected and blocked 47 failed login attempts from IP 10.0.1.105. IP added to temporary blocklist.",
